...
/**
 * Classe de teste para demonstrar o funcionamento das regras de negócio
 * implementadas no sistema bancário
 */
public class TesteSistemaBancario {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            banco.criarConta(1001, 1000.0, cliente1);
            System.out.println("   ✓ Conta 1001 criada com sucesso para " + cliente1.getNome());

            // Criar segunda conta (deve funcionar)
            banco.criarConta(1002, 500.0, cliente2);
            System.out.println("   ✓ Conta 1002 criada com sucesso para " + cliente2.getNome());

            // Tentar criar conta com mesmo número (deve lançar exceção)
            System.out.println("   ✗ Tentando criar conta duplicada...");
            try {
                banco.criarConta(1001, 200.0, cliente2);
            ...
            // Tentar criar conta com saldo negativo (deve lançar exceção)
            System.out.println("   ✗ Tentando criar conta com saldo negativo...");
            try {
                banco.criarConta(1003, -100.0, cliente1);
            ...
            // Depositar valor positivo (deve funcionar)
            banco.depositar(1001, 500.0);
            System.out.println("   ✓ Depósito de R$ 500,00 realizado na conta 1001");

            // Tentar depositar valor negativo (deve lançar exceção)
            ...
            // Sacar valor válido (deve funcionar)
            banco.sacar(1001, 200.0);
            System.out.println("   ✓ Saque de R$ 200,00 realizado na conta 1001");

            // Tentar sacar valor maior que saldo (deve lançar exceção)
            ...
            // Tentar sacar valor negativo (deve lançar exceção)
            ...
            // Tentar transferir para conta inexistente (deve lançar exceção)
            ...
            // Tentar transferir valor negativo (deve lançar exceção)
            ...
            // Tentar transferir valor maior que saldo (deve lançar exceção)
            ...
            // Emitir extrato da conta 1001
            String extrato1001 = banco.emitirExtrato(1001);
            System.out.println("   ✓ Extrato da conta 1001:");
            System.out.println(extrato1001);

            // Emitir extrato da conta 1002
            String extrato1002 = banco.emitirExtrato(1002);
            System.out.println("   ✓ Extrato da conta 1002:");
            System.out.println(extrato1002);

            // Tentar emitir extrato de conta inexistente (deve lançar exceção)
            System.out.println("   ✗ Tentando emitir extrato de conta inexistente...");
            try {
                banco.emitirExtrato(9999);
            ...
            System.out.println("✓ Sistema implementado com todas as regras de negócio");
            System.out.println("✓ Tratamento de exceções funcionando corretamente");
            System.out.println("✓ Uso da Collections API implementado");
            System.out.println("✓ Movimentações ordenadas por data");
